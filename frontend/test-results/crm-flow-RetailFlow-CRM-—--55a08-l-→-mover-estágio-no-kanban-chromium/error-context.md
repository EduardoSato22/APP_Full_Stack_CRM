...
- Name: crm-flow.spec.ts >> RetailFlow CRM — Fluxo Principal >> criar deal → mover estágio no kanban
- Location: e2e\crm-flow.spec.ts:59:3
...
Call log:
  - waiting for locator('text=Negociações')
    - locator resolved to <span class="MuiTypography-root MuiTypography-body1 MuiListItemText-primary css-jyfsso-MuiTypography-root">Negociações</span>
